	...
	<script language="javascript" src="<?php echo $baseDir; ?>/www/js/calendar-1.5.js"></script>
 	<script type='text/javascript'>
		...
		function doSearch(start_date, end_date) {
			...
			$.post("<?php echo $baseDir; ?>/admin/search_photo", {
				...
				html += "<th style='text-align:center;width:150px;'>E-mailadres</th>";
				html += "<th style='text-align:center;width:100px;'>Merk</th>";
				...
				<ul id="navigation">
					...
					<li class="sub active">
						...
						<ul>
							...
							<li class="current"><a href="<?php echo $baseDir; ?>/admin/donate_photo">Laatst gedoneerde foto</a></li>				
						</ul>
					</li> 
					<li class="sub">
					...
					<div class="panel">
						...
						<div class="title">
							<div class="headline first">
								<label>Laatste 5 geuploade foto's</label> 
							</div>
						</div>
