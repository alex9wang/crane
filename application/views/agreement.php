...
<head>
	...
	<script type='text/javascript'>
		...
		function onClickSave() {
			var policy_dutch    = editor1.getData();
			var policy_german   = editor2.getData();
			var policy_french	= editor3.getData();

			if(policy_dutch == "")
			{
				alert("Verander gebruikersvoorwaarden in het Nederlands");
				return;
			}
			else if(policy_german == "")
			{
				alert("Verander gebruikersvoorwaarden in het Duits");
				return;
			}
			else if(policy_french == "")
			{
				alert("Verander gebruikersvoorwaarden in het Frans");
				return;
			}
			// save text of policy
			$('.preview').css("display", "block");
			$('.preview').spin();
			$.post("<?php echo $baseDir; ?>/admin/set_policy", {policy_dutch : policy_dutch, policy_german: policy_german, policy_french: policy_french}, function(data) {
			     $('.preview').spin(false);
				 $('.preview').css("display", "none");
			     alert("Veranderen voorwaarden geslaagd");			    
			});
		}
			...
			<div id="sidebar" class="threecol">
				<ul id="navigation">
					...
					<li class="sub active">
						...
						<ul>
							<li class="current"><a href="<?php echo $baseDir; ?>/admin/userpolicy">Gebruikersvoorwaarden</a></li>
					...
					<div class="panel">
						...
						<div class="tabs">
							<ul>
								...
								<li class="last"><a href="#" rel="tab-02-content">Duits</a></li>
