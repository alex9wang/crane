...
<head>
	...
	<script type='text/javascript'>
		...
		function onClickSave() {
			var help_dutch    = editor1.getData();
			var help_german   = editor2.getData();
			var help_french	= editor3.getData();

			if(help_dutch == "")
			{
				alert("Pas help-tekst aan in Nederlands");
				return;
			}
			else if(help_german == "")
			{
				alert("Pas help-tekst aan in Duits");
				return;
			}
			else if(help_french == "")
			{
				alert("Pas help-tekst aan in Frans");
				return;
			}
			// save text of policy
			$('.preview').css("display", "block");
			$('.preview').spin();
			$.post("<?php echo $baseDir; ?>/admin/set_help", {help_dutch : help_dutch, help_german: help_german, help_french: help_french}, function(data) {
			     $('.preview').spin(false);
				 $('.preview').css("display", "none");
			     alert("User Help save successful");			    
			});
		}
				...
				<ul id="navigation">
					...
					<li class="sub">
						...
						<ul>
							...
							<li><a href="<?php echo $baseDir; ?>/admin/add_administrator">Voeg administrator toe</a></li>
					...
					<li class="sub active">
						...
						<ul>
							...
							<li class="current"><a href="<?php echo $baseDir; ?>/admin/help">Help informatie</a></li>
						</ul>
					</li> 
					<li class="sub">
